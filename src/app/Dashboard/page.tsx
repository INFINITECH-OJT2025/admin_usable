  ...
  useEffect(() => {
    const fetchUserCounts = async () => {
      try {
        ...
        if (authToken) {
          const response = await axios.get("http://127.0.0.1:8000/api/countUsers", {
                        ...
                        <div className="card-body">
                          <div className="card-title d-flex align-items-start justify-content-between">
                            <div className="avatar flex-shrink-0">
                              <img
                                src="../assets/img/icons/unicons/admin-icon.png"
                                alt="chart success"
                                className="rounded"
                              />
                            </div>
                          ...
                          <span className="fw-semibold d-block mb-1">Users</span>
                          <h3 className="card-title mb-2">{userCount}</h3>
                      ...
                      <div className="card">
                        <div className="card-body">
                          <div className="card-title d-flex align-items-start justify-content-between">
                            <div className="avatar flex-shrink-0">
                              <img
                                src="../assets/img/icons/unicons/user-icon.png"
                                alt="Credit Card"
                                className="rounded"
                              />
                            </div>
                          ...
                          <span>Admin</span>
                          <h3 className="card-title mb-2">{adminCount}</h3>
